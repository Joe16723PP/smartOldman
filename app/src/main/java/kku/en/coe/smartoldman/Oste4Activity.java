...
public class Oste4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            obj = new JSONObject(loadJSONFromAsset(Oste4Activity.this));
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                index = max_length - 2;
                send_index = index;
                Intent intent = new Intent(Oste4Activity.this,Oste3Activity.class);
