...
public class Hyper2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            obj = new JSONObject(loadJSONFromAsset(Hyper2Activity.this));
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (index_int <= 0) {
                    Intent intent = new Intent(Hyper2Activity.this,Hyper1Activity.class);
                    intent.putExtra("index", String.valueOf(send_index));
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(Hyper2Activity.this,Hyper3Activity.class);
                    intent.putExtra("index", String.valueOf(send_index));
                    startActivity(intent);
                }
            }
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (index_int >= (max_length - 1)) {
                    Intent intent = new Intent(Hyper2Activity.this,Hyper4Activity.class);
                    intent.putExtra("index", String.valueOf(send_index));
                    startActivity(intent);
                    Log.e("HACK", String.valueOf(max_length));
                } else {
