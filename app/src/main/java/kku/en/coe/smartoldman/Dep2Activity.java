...
public class Dep2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView text_title, text_desc, txt_link, img_sub;
    ...
    public void onClick(View v) {
        if ( v == btn_back) {
            ...
            if (index >= (max_length - 1)) {
                Intent intent = new Intent(this,Dep4Activity.class);
                intent.putExtra("index", String.valueOf(index));
                intent.putExtra("return_point",rt_point);
                startActivity(intent);
