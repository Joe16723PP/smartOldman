...
public class Dep3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            obj = new JSONObject(loadJSONFromAsset(Dep3Activity.this));
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (index_int <= 0) {
                    Intent intent = new Intent(Dep3Activity.this,Dep1Activity.class);
                    intent.putExtra("index", String.valueOf(send_index));
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(Dep3Activity.this,Dep2Activity.class);
                    intent.putExtra("index", String.valueOf(send_index));
                    startActivity(intent);
                }
            }
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (index_int >= (max_length - 1)) {
                    Intent intent = new Intent(Dep3Activity.this,Dep4Activity.class);
                    intent.putExtra("index", String.valueOf(send_index));
