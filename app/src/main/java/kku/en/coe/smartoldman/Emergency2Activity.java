        ...
        img_sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (ActivityCompat.checkSelfPermission(Emergency2Activity.this,android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        if (ActivityCompat.shouldShowRequestPermissionRationale(Emergency2Activity.this,
                                android.Manifest.permission.CALL_PHONE)) {
                        } else {
                            ActivityCompat.requestPermissions(Emergency2Activity.this,
