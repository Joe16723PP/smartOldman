...
public class Diab4Activity extends AppCompatActivity implements View.OnClickListener {
...
//        Log.e("HACK", String.valueOf(index_int));
    ...
    private void readJson() {
        try {
            ...
            sick = (JSONArray) obj.get("diabetes");
    ...
    public void onClick(View v) {
        if ( v == btn_back) {
            ...
            if ( index <= 0 ) {
                ...
                Intent intent = new Intent(this,Diab3Activity.class);
                intent.putExtra("index",String.valueOf(index));
                intent.putExtra("return_point",rt_point);
                startActivity(intent);
            }
