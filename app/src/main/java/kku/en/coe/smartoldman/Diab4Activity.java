...
public class Diab4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            obj = new JSONObject(loadJSONFromAsset(Diab4Activity.this));
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                index = max_length - 2;
                send_index = index;
                Intent intent = new Intent(Diab4Activity.this,Diab3Activity.class);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Diab4Activity.this,DiseaseActivity.class);
                startActivity(intent);
            }
        });
    }
