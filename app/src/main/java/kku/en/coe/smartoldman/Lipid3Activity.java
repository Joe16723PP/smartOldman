...
public class Lipid3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if ( v == btn_back) {
            ...
            if (index >= (max_length - 1)) {
                Intent intent = new Intent(this,Lipid4Activity.class);
                intent.putExtra("index", String.valueOf(index));
                intent.putExtra("return_point",rt_point);
                startActivity(intent);
