...
public class Oste3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            obj = new JSONObject(loadJSONFromAsset(Oste3Activity.this));
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (index_int <= 0) {
                    Intent intent = new Intent(Oste3Activity.this,Oste1Activity.class);
                    intent.putExtra("index", String.valueOf(send_index));
                    startActivity(intent);
                } else {
                    Intent intent = new Intent(Oste3Activity.this,Oste2Activity.class);
                    intent.putExtra("index", String.valueOf(send_index));
                    startActivity(intent);
                }
            }
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (index_int >= (max_length - 1)) {
                    Intent intent = new Intent(Oste3Activity.this,Oste4Activity.class);
                    intent.putExtra("index", String.valueOf(send_index));
