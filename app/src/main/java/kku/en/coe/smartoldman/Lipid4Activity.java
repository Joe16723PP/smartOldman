...
public class Lipid4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            obj = new JSONObject(loadJSONFromAsset(Lipid4Activity.this));
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                index = max_length - 2;
                send_index = index;
                Intent intent = new Intent(Lipid4Activity.this,Lipid3Activity.class);
